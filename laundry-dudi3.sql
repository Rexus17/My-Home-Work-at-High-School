...
(6, '2023_02_28_011517_create_members_table', 1),
(7, '2023_02_28_011729_create_pakets_table', 1),
(8, '2023_02_28_012001_create_detail_transaksis_table', 1),
(9, '2023_02_28_012856_create_transaksis_table', 1),
(10, '2023_02_28_013041_create_outlets_table', 1),
(11, '2023_02_28_014227_create_roles_table', 1);
...
CREATE TABLE `transaksis` (
  ...
  `biaya_tambahan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
ALTER TABLE `detail_transaksis`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `detail_transaksis_id_transaksi_unique` (`id_transaksi`),
  ADD UNIQUE KEY `detail_transaksis_id_paket_unique` (`id_paket`);
...
ALTER TABLE `pakets`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `pakets_id_outlet_unique` (`id_outlet`);
...
ALTER TABLE `transaksis`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `transaksis_id_outlet_unique` (`id_outlet`),
  ADD UNIQUE KEY `transaksis_id_member_unique` (`id_member`),
  ADD UNIQUE KEY `transaksis_id_user_unique` (`id_user`);
